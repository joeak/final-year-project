...
<body  style="background: url(http://subtlepatterns2015.subtlepatterns.netdna-cdn.com/patterns/kindajean.png);">
	...
	<!-- heading with the weight type selected -->
	<h4 class="text-center"><b>View your months results <?php
  ...
  <hr>
	...
	<h4 class="text-center"><b><?php echo $first_name ?>'s progress on <?php echo $ex_name ?></b></h4> <span class="h4">
	  ...
	  <!-- buttons to change between quarterly, monthy and weekly views of the graph -->
		...
		<div class="btn-group btn-group-justified">
			<a href="postTrack.php?ex_name=<?php echo $ex_name ?>&weighttype=kg" type='button' name="kg" class='btn btn-primary' value="track">Change to kg</a>
			<a href="postTrack.php?ex_name=<?php echo $ex_name ?>&weighttype=lbs"  type='button' name="lbs" class='btn btn-primary' value="track">Change to lbs</a>
			</div>
