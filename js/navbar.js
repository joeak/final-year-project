...
function departmentSelect(){
	...
	if (document.getElementById("firstSelect").value == "CO"){
		...
		newHtml += "<option disabled selected style='display:none;'></option>";
...
function OOPSelect() {
	...
	var moduleCode = document.getElementById("moduleCode").value;
		if(moduleTitle == "Object Oriented Programming" && moduleCode == "COA900"){
					
			document.getElementById("Semester").value = "1";
			document.getElementById("Startweek").value = "1";
			document.getElementById("Endweek").value = "12";
			...
			document.getElementById("RoomPreference").value = "-";
			document.getElementById("quantity").value = "100";
			document.getElementById("T/S").value = "1";
			document.getElementById("DataProj").value = "1";
			document.getElementById("park").value = "1";
			document.getElementById("NumberofRooms").value = "1";
			document.getElementById("OHPwriting").value = "1";
...
function clearbooking(){
			...
			document.getElementById("T/S").value = "";
			document.getElementById("DataProj").value = "";
			document.getElementById("park").value = "";
			document.getElementById("NumberofRooms").value = "";
			document.getElementById("OHPwriting").value = "";
			document.getElementById("specialreq").value = "";
