...
<body  style="background: url(http://subtlepatterns2015.subtlepatterns.netdna-cdn.com/patterns/kindajean.png);">
	...
	<h4 class="text-center"><b>View your weeks results <?php
	...
	<h4 class="text-center"><b><?php echo $first_name ?>'s progress on <?php echo $ex_name ?></b></h4> <span class="h4">
		...
		<div class="btn-group btn-group-justified">
			<a href="postTrackWeek.php?ex_name=<?php echo $ex_name ?>&weighttype=kg" type='button' name="kg" class='btn btn-primary' value="track">Change to kg</a>
			<a href="postTrackWeek.php?ex_name=<?php echo $ex_name ?>&weighttype=lbs"  type='button' name="lbs" class='btn btn-primary' value="track">Change to lbs</a>
		</div>
